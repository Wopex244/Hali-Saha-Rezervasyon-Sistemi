...
import fieldsHandler from './api/fields.ts';
...
app.get('/api/reservations', toVercelHandler(reservationsHandler));
app.post('/api/reservations', toVercelHandler(reservationsHandler));
app.put('/api/reservations', toVercelHandler(reservationsHandler));
app.get('/api/fields', toVercelHandler(fieldsHandler));
