...
import { Trophy, Phone, MapPin, Menu, X, User, LogOut, Settings } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center gap-2 group">
              <img src="/image.png" alt="Halı Saha Logo" className="w-10 h-10 rounded-full object-cover transition-transform group-hover:scale-105" />
              <span className="font-display text-2xl tracking-wider">HALI SAHA</span>
            </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <img src="/image.png" alt="Halı Saha Logo" className="w-10 h-10 rounded-full object-cover" />
                <span className="font-display text-2xl tracking-wider">HALI SAHA</span>
              </div>
              <p className="text-primary-foreground/70 text-sm">
                En iyi halı saha deneyimi için hemen rezervasyon yapın.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <a href="tel:+905057458251" className="flex items-center gap-3 text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  ...
                  <span className="text-sm">+00 000 000 00 00</span>
                </a>
                <div className="flex items-start gap-3 text-primary-foreground/80">
                  <MapPin className="w-4 h-4 mt-0.5" />
                  <span className="text-sm">Test,<br />Test,<br />Test</span>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center">
            <p className="text-sm text-primary-foreground/60">
              © 2025 Halı Saha. Tüm hakları saklıdır.
            </p>
          </div>
        </div>
      </footer>
